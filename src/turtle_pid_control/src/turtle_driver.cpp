...
bool go_to_destination(turtle_pid_control::xygoal::Request  &req, turtle_pid_control::xygoal::Response &res)
{
  float tol=1;
...
int main(int argc, char **argv)
{
  ...
  ros::NodeHandle n;
  ros::ServiceServer service = n.advertiseService("turtle_driver", go_to_destination);

  ROS_INFO("Ready to drive turtle");
  ros::spin();
